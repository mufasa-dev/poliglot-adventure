...
import { createLesson, findLessonsByCourse, findLessonsByUser } from "../../../models/lesson.model";

export const prerender = false;

// GET /api/lessons → retorna todas as lessons do usuário logado (ou de um curso específico)
export const GET: APIRoute = async ({ request }) => {
  try {
    ...
    const lessons = courseId
      ? await findLessonsByCourse(courseId)
      : await findLessonsByUser(userId.toString());
